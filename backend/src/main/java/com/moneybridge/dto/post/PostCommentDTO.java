...
public class PostCommentDTO {
    ...
    public static PostCommentDTO toDTO(PostComment postComment) {
        ...
        return PostCommentDTO.builder()
                ...
                .loanAmount(postComment.getLoanAmount()) // PostComment에서 대출 금액 가져오기
                .repaymentPeriod(postComment.getRepaymentPeriod()) // PostComment에서 상환 기간 가져오기
                .fee(postComment.getFee()) // PostComment에서 수수료 가져오기
