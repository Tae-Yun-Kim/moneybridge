# fullstack_second
Spring Boot, React, RESTful API, Python, AWS 를 활용한 두번째 풀스택 프로젝트(금융)

## 프로젝트 소개
개인 간 금융 거래를 할 수 있고 수수료를 기부하는 금융 프로젝트
...
![KakaoTalk_20250206_180354427](https://github.com/user-attachments/assets/0718dea7-116e-49bf-bdfa-40d7c0b2f4e6)

![주석 2025-02-08 180452](https://github.com/user-attachments/assets/dcdc8a14-a7e1-4492-a2ef-e062b9893140)
