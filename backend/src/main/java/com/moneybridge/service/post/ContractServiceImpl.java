...
//
//        // ✅ 잔액 확인
//        if (borrowerWallet.getBalance() < contract.getLoanAmount()) {
//            throw new IllegalArgumentException("잔액 부족");
//        }
//
//        // ✅ 변경: 총 상환 금액으로 업데이트
//        long repaymentAmount = contract.getTotalRepaymentAmount(); // 🔹 총 상환 금액 사용
//
//// 🔹 대출자 지갑 출금
